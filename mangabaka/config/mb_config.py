...
# Credentials
EMAIL, PASSWORD = get_tracker_credentials("mangabaka")

# Paths
EXPORTS_DIR = tracker_exports_dir("mangabaka")
LOGS_DIR = tracker_logs_dir("mangabaka")
...
def setup_logging():
    logger = logging.getLogger("mb_export")
    if logger.handlers:
        return logger
